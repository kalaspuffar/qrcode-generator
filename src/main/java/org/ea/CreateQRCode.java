...
//        de.encode(quality, CharacterEncoding.ALPLANUMERIC, "HELLO WORLD");
        de.encode(quality, CharacterEncoding.BYTE, "Hello explorers, thank you for watching my videos. I hope you will love this explaination on how QR Codes works and are generated.");
